...
@section('content')
    ...
    <div class="report-kpis">
        <div class="s-card">
            ...
            <div class="meta">
                <div class="n">{{ number_format($totRevenue ?? array_sum($chartRevenues)) }} ₫</div>
                <div class="t">Tổng doanh thu</div>
                <div class="text-muted small">Trong khoảng đã chọn</div>
            </div>
        </div>
        <div class="s-card">
            <div class="icon"><i class="bi bi-coin"></i></div>
            <div class="meta">
                <div class="n">{{ number_format($totCost ?? array_sum($chartCosts)) }} ₫</div>
                <div class="t">Tổng chi phí</div>
                <div class="text-muted small">Giá vốn được tính</div>
            </div>
        </div>
        <div class="s-card">
            <div class="icon"><i class="bi bi-graph-up-arrow"></i></div>
            <div class="meta">
                <div class="n">{{ number_format($totProfit ?? array_sum($chartProfits)) }} ₫</div>
                <div class="t">Lợi nhuận</div>
                <div class="text-muted small">Doanh thu - Chi phí</div>
            </div>
        </div>
        <div class="s-card">
            <div class="icon"><i class="bi bi-check2-circle"></i></div>
            <div class="meta">
                <div class="n">{{ number_format($ordersCount ?? 0) }}</div>
                <div class="t">Đơn hoàn thành</div>
                <div class="text-muted small">AOV: {{ number_format($avgOrder ?? 0) }} ₫</div>
            </div>
        </div>
    </div>
