  ...
  {{-- Filter theo giá --}}
    <div class="filter-card container mb-3">
      <form id="priceFilterForm" method="GET" action="{{ url()->current() }}" class="row g-3 align-items-end">
        {{-- Giữ tham số tìm kiếm và per_page --}}
        ...
        <div class="col-6 col-md-3">
          ...
          <input type="number" name="min_price" min="0" step="1000" class="form-control"
                value="{{ request('min_price') }}">
        </div>
        <div class="col-6 col-md-3">
          <label class="form-label">Đến giá (VNĐ)</label>
          <input type="number" name="max_price" min="0" step="1000" class="form-control"
        ...
        <div class="col-6 col-md-3 d-flex gap-2">
          ...
          <a href="{{ url()->current() }}?q={{ urlencode(request('q','')) }}" class="btn btn-outline-secondary flex-fill">Xoá lọc</a>
        </div>
